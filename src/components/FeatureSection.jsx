...
const FeatureSection = () => {
  ...
  return (
    <section className='max-w-7xl mx-auto px-4 py-16 capitalize'>
        {/* heading */}
        <div className='text-center mb-12'>
            <h2 className='text-3xl font-bold mb-4'>How can we help your business</h2>
            <p className='text-gray-600'>when you resell, you build trust</p>
        </div>
         ...
         <div className='text-center mt-12'>
            ...
            px-8 py-3 rounded-full font-medium hover:bg-blue-800
            transition-colors relative'>
            Become A Partner
            <div className='absolute -z-10 w-full h-full rounded-full
            bg-blue-600/50 blur-xl top-0 left-0'></div>
            </button>
         </div>
